...
class Test_item_model extends CI_Controller
{
    ...
    public function test_register_item()
    {
        ...
        $test = $this->Item_model->register_item("legumbres");
    ...
    public function test_get_items()
    {
        ...
        $test = $this->Item_model->get_items();
    ...
    public function test_item_exists()
    {
        ...
        $test = $this->Item_model->item_exists("carnes");
        $expected_result = TRUE;
    ...
    public function test_get_amount_category_by_item()
    {
        ...
        $test = $this->Item_model->get_amount_category_by_item(1);
    ...
    public function test_get_letters_item()
    {
        ...
        $test = $this->Item_model->get_letters_item(1);
        $result = $test->letter;
        $expected_result = "CAR";
