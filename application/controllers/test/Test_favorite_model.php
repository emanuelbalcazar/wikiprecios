...
class Test_favorite_model extends CI_Controller
{
    ...
    public function test_register_favorite_trade()
    {
        ...
        $test = $this->Favorite_model->register_favorite_trade("emanuelbalcazar13@gmail.com", 1);
    ...
    public function test_delete_all_favorites()
    {
        ...
        $test = $this->Favorite_model->delete_all_favorites("emanuelbalcazar13@gmail.com");
        $expected_result = TRUE;
